...
def initializer():
    ...
    return sys, np, pd, emcee, random, mm_runprops, mm_init_guess, mm_likelihood, mm_make_geo_pos, mm_priors, mm_relast, mm_autorun, mm_param, mm_clustering, os, mm_analysis, warnings, shutil, json, writer, Manager, tqdm
...
if __name__ == '__main__':
    ...
    with MPIPool() as pool:
        ...
        if not pool.is_master():
            ...
            sys.exit(0)
        #print('initializer')  
        sys, np, pd, emcee, random, mm_runprops, mm_init_guess, mm_likelihood, mm_make_geo_pos, mm_priors, mm_relast, mm_autorun, mm_param, mm_clustering, os, mm_analysis, warnings, shutil, json, writer, Manager, tqdm = initializer()
