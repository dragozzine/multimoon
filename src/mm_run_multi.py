...
# DS TODO: Potentially work on making this somewhat readable. Put things in functions and don't copy and paste code.
...
#If you are not starting from a previous run
        ...
        # All of this just checks that parameters in intial guesses matches the 
        # dynamics to include flags
            print(paramnames)
