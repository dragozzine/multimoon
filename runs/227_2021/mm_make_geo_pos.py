...
def mm_make_geo_pos(objname, times, runprops = None, synthetic = False):
    ...
    fileName2 = "geocentrics/geocentric_" + objname +'_position.csv'
...
def build_geo_analysis(objname, obsdf):
    ...
    geo_obj_pos = mm_make_geo_pos(objname, timesdic, runprops = None, synthetic = True)
    return geo_obj_pos
